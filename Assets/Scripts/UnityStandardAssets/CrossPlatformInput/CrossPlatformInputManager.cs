...
namespace UnityStandardAssets.CrossPlatformInput
{
	public static class CrossPlatformInputManager
	{
		...
		private static VirtualInput s_TouchInput = new UnityStandardAssets.CrossPlatformInput.PlatformSpecific.MobileInput();

		private static VirtualInput s_HardwareInput = new UnityStandardAssets.CrossPlatformInput.PlatformSpecific.StandaloneInput();
