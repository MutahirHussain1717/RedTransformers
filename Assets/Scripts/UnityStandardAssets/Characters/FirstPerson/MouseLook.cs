...
namespace UnityStandardAssets.Characters.FirstPerson
{
	...
	public class MouseLook
	{
		...
		{
			float y = UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetAxis("Mouse X") * this.XSensitivity;
			float num = UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetAxis("Mouse Y") * this.YSensitivity;
