...
namespace UnityStandardAssets.Characters.FirstPerson
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			if (!this.m_Jump)
			{
				this.m_Jump = UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetButtonDown("Jump");
			}
		...
		{
			float axis = UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetAxis("Horizontal");
			float axis2 = UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetAxis("Vertical");
