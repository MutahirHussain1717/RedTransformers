...
namespace UnityStandardAssets.Utility
{
	public class SimpleMouseRotator : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			if (this.relative)
			{
				float num = UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetAxis("Mouse X");
				float num2 = UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetAxis("Mouse Y");
			...
			{
				float num = UnityEngine.Input.mousePosition.x;
				float num2 = UnityEngine.Input.mousePosition.y;
