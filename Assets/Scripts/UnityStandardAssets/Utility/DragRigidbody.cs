...
namespace UnityStandardAssets.Utility
{
	public class DragRigidbody : MonoBehaviour
	{
		private void Update()
		{
			...
			if (!Physics.Raycast(camera.ScreenPointToRay(UnityEngine.Input.mousePosition).origin, camera.ScreenPointToRay(UnityEngine.Input.mousePosition).direction, out raycastHit, 100f, -5))
			{
				return;
			}
