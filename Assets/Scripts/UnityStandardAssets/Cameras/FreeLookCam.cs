...
namespace UnityStandardAssets.Cameras
{
	public class FreeLookCam : PivotBasedCameraRig
	{
		...
		private void HandleRotationMovement()
		{
			...
			float axis = UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetAxis("Mouse X");
			float axis2 = UnityStandardAssets.CrossPlatformInput.CrossPlatformInputManager.GetAxis("Mouse Y");
